        ...
        { //Objecto para obter informacao sobre os workers a partir do ficheiro de texto com nome fileName
            ...
            while((workerCoord = inFile.readLine())!=null)
            {
                ...
                try
                {
                    ...
                    workerName = sc.next();
                    workerPort = Integer.parseInt(sc.next());
                }
                catch(Exception e)
                {
                ...
                try
                {
                   ...
                   Socket w = new Socket(workerName, workerPort);
                   workers.add(w);
    ...
    public static void main(String[] args) throws InterruptedException
    {
        ...
        try
        {
            ...
            for(i=0; i<nWorkers; i++)
            {
                ...
                RequestToWorker rtw = new RequestToWorker(i+1, nWorkers, nIntervals);
                //Envia-lhe o pedido
                output.writeObject(rtw);
                output.flush();
            }
